...
third_party/pdo-pglite/pdo_pglite.c: $(wildcard ${PDO_PGLITE_DEV_PATH}/*)
	...
	cp -Lprfv ${PDO_PGLITE_DEV_PATH} third_party/
	touch third_party/pdo-pglite/pdo_pglite.c
else
...
third_party/php${PHP_VERSION}-src/ext/pdo_pglite/%: third_party/pdo-pglite/% third_party/php${PHP_VERSION}-src/patched
	...
	${DOCKER_RUN} cp -TLprfv third_party/pdo-pglite/ third_party/php${PHP_VERSION}-src/ext/pdo_pglite
