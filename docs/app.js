  ...
  Object.defineProperty(this, 'add', {
    ...
    value: function value(callback) {
      if (_this.byObject.has(callback)) {
        var _newid = _this.byObject.get(callback);
