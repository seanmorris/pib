...
var PhpBase = /*#__PURE__*/function (_EventTarget) {
  ...
  _createClass(PhpBase, [{
    ...
    value: function request() {
      var filepath = '/preload/dump-request.php';
      var method = 'POST';
      var request_uri = '/';
      var query_string = 'hello=world';
      var cookie_data = '';
      var content_type = '';
      var post_data = 'hai2=you';
      var call = this.binary.then(function (php) {
        return php.ccall('pib_request', NUM, [STR, STR, STR, STR, STR, STR, STR], [filepath, method, request_uri, query_string, cookie_data, content_type, post_data], {
          async: true
        });
      });
      call["catch"](function (error) {
...
var ASM_CONSTS = {
 ...
 3583408: $0 => "function" === typeof Module.targets.get($0) ? $0 : 0,
 3583476: $0 => !!(Module.targets.get($0).prototype && Module.targets.get($0).prototype.constructor),
 3583577: ($0, $1, $2) => {
  (() => {
   const target = Module.targets.get($0);
   const property = UTF8ToString($1);
 ...
 3586321: $0 => "function" === typeof Module.targets.get($0) ? $0 : 0,
 3586389: $0 => !!(Module.targets.get($0).prototype && Module.targets.get($0).prototype.constructor),
 3586490: ($0, $1, $2) => {
  (() => {
   const target = Module.targets.get($0);
   const property = $1;
 ...
 3590928: $0 => Module.jsToZval(Module[UTF8ToString($0)]),
 3590982: ($0, $1, $2, $3) => {
 ...
 3593681: () => Module.targets.getId(globalThis),
 3593726: ($0, $1) => {
  let target = Module.targets.get($0);
  const property = $1;
  if (target instanceof ArrayBuffer) {
...
var _pib_request = Module["_pib_request"] = createExportWrapper("pib_request");
...
var ___start_em_js = Module["___start_em_js"] = 3594809;

var ___stop_em_js = Module["___stop_em_js"] = 3595451;
